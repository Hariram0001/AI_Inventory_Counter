...
| Experimental Features | Shape Detection history/save policy (page is open to all signed-in users) |
...
Shape Detection is opened from the **left sidebar** icon (Work in progress), not
from Home. See [`SHAPE_DETECTION_TESTING.md`](SHAPE_DETECTION_TESTING.md).
